...
export class ModullerService {
  private modulesList = signal<ModuleItem[]>([
    ...
    },
    {
      id: 'gecis-modulleri',
      key: 'gecis-modulleri',
      name: 'Geçiş Modülleri',
      description: 'Greenfield, Selective Data Transition ve Brownfield geçiş alternatifleri analizi',
      icon: 'shuffle',
      slides: [
        {
          id: 'gm-1',
          slideTag: 'GEÇİŞ MODÜLLERİ',
          mainTitle: 'S/4HANA Geçiş Modülleri & Dönüşüm Metodolojisi',
          cards: [
            {
              id: 'gm-c1',
              title: 'Greenfield (Yeniden Kurulum)',
              severity: 'UYGUN DEĞİL',
              bullets: [
                'Ana veri ve süreçler temiz kurulur, ama geçmiş işlem verisi varsayılan olarak gelmez.',
                'Sadece açılış bakiyeleri taşınır — geçmiş verinin mutlaka istenmesi şartıyla çelişir.'
              ]
            },
            {
              id: 'gm-c2',
              title: 'Selective Data Transition',
              severity: 'KISMEN UYGUN',
              bullets: [
                'Seçili alanlarda (CO ana verisi, BP dönüşümü) temiz kurulum ile geçmiş verinin taşınmasını birlikte yönetir.',
                'MM/FI çekirdeği korunurken, sorunlu alanlar yeniden tasarlanır.',
                'Kullanılan özel toollar ve uzun proje süresi maliyetleri yükseltir.'
              ]
            },
            {
              id: 'gm-c3',
              title: 'Brownfield (Teknik Dönüşüm)',
              severity: 'ÖNERİLEN',
              bullets: [
                'Geçmiş işlem verisi otomatik korunur.',
                'CO ana veri kalitesini ve satıcı/müşteri (BP) sadeleştirmeleri ve yüksek verili atıl veriler geçiş sonrası arşivlenir.',
                'Proje Maliyeti ve Süresi en uygun çözüm'
              ]
            },
            {
              id: 'gm-c4',
              ...
              isFullWidth: true,
              bullets: [
                "Geçmiş işlem verisinin yeni sistemde de erişilebilir olması gerekiyor; bu, saf greenfield'ı büyük ölçüde eliyor.",
                'Önerilen model: MM/FI çekirdeği brownfield mantığıyla dönüştürülür; CO ana verisi ve BP dönüşümü selective transition araçlarıyla temiz kurulup geçmiş hareketler yeni yapıya eşlenerek taşınır.',
                "Bu sayede hem raporlama sürekliliği (trend/yıl karşılaştırması) korunur hem de mevcut ana veri kirliliği S/4HANA'ya taşınmamış olur."
              ]
            }
          ]
        }
    ...
    },
    {
      id: 'yol-haritasi',
      key: 'yol-haritasi',
      name: 'Önerilen Yol Haritası',
      description: 'Geçiş stratejisi, Shell Conversion ve System Conversion alternatifleri',
      icon: 'map',
      slides: [
        {
          id: 'yh-1',
          slideTag: 'GEÇİŞ STRATEJİSİ',
          mainTitle: 'Önerilen Yol haritası',
          cards: [
            {
              id: 'yh-c1',
              title: 'Selective Data Transition (Shell Conversion)',
              severity: 'KISMEN UYGUN',
              bullets: [
                'Digital Blueprint ile taşınacak/taşınmayacak verinin kapsamı belirlenir (SAP Business Transformation Center / Lean SDT).',
                "Mevcut sistemin 'kabuk' (shell) kopyası oluşturulur — teknik altyapı ve konfigürasyon taşınır, uygulama verisi taşınmaz.",
                "Shell sistem S/4HANA'ya dönüştürülür/yükseltilir.",
                'Seçilen ana veri ve işlem verisi, organizasyon birimi ve zaman dilimi filtreleriyle Lean SDT/DMLT veya partner araçlarıyla (SNP, cbs, Natuvion) göç ettirilir; göç sırasında veri temizlenip dönüştürülebilir.',
                'Veri doğrulama, entegrasyon testleri ve go-live işlemleri tamamlanır.'
              ],
              footerNote: 'Tahmini Süre: 12 Ay'
            },
            {
              id: 'yh-c2',
              ...
              severity: 'ÖNERİLEN',
              bullets: [
                "SAP Readiness Check ve Custom Code Check ile mevcut sistemin S/4HANA uyumluluğu analiz edilir.",
                "Zorunlu 'simplification item'lar (ör. Business Partner dönüşümü, Malzeme Defteri aktivasyonu) ve uyumsuz Z programları belirlenir.",
                "Custom kod S/4HANA'ya uyarlanır; gereksiz Z programlar elenir.",
                "Sistem, mevcut tüm geçmiş veri ve konfigürasyonuyla birlikte teknik olarak S/4HANA'ya dönüştürülür (in-place conversion).",
                'Test ve go-live; ana veri ve geçiş dataları sistemle birlikte taşınır.',
                'Yapılacak bir arşivleme projesi ile yüksek hacimli ve istenmeyen veriler arşivlenir.',
                'LShift işlemi ile temiz veriler Rise sistemine taşınır.'
              ],
              footerNote: 'Tahmini Süre: 6 Ay'
            }
          ]
        }
      ]
